 ...
 *
 * <p> These values will vary based on the the
 * way the application is configured in the Android Market publishing console, such as whether the
 * application is marked as free or is within its refund period, as well as how often an application
 * is checking with the licensing service.
 *
 * <p> Developers who need more fine grained control over
