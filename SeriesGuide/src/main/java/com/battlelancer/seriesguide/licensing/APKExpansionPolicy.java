...
package com.battlelancer.seriesguide.licensing;
 ...
 *
 * <p> Developers who need more fine grained control over their application's licensing policy
 * should implement a custom Policy.
 */
public class APKExpansionPolicy implements Policy {
     ...
     *
     * <p> This data will be used for computing future policy decisions. The following parameters
     * are processed: <ul> <li>VT: the timestamp that the client should consider the response valid
     * until <li>GT: the timestamp that the client should ignore retry errors until <li>GR: the
